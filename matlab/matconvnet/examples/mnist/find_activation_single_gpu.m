...
load([mainDir '/mnist-resnet-' num2str(depth) '/net-epoch-113.mat']); 
...
save([mainDir '/res-' num2str(depth) '-activations.mat'],'activation_max' , 'activation_9999', 'activation_999', 'activation_99');
